package com.yeogibook.search.result.presentation.units.empty
...
class SearchResultEmptyUiItem : LazyItem<SearchResultIntent>() {
...
@Composable
private fun Preview() {
    SearchResultEmptyUiItem().BuildItem { }
}